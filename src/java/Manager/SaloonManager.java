...
public class SaloonManager {
    ...
    public static List<CommonBean> getAllSaloonByAreaId_And_SubId(int area_id,int sub_id)
    {
       ResultSet rs=null;
       String query="SELECT Places.Place_Id,Places_name,Address,Contact_no,Website_name,Description,Image_name,TYPE FROM places INNER JOIN saloon ON saloon.Place_Id=places.Place_Id INNER JOIN place_image ON place_image.Place_Id=places.Place_Id\n" +
       ...
       /* for(CommonBean bean:list)
        {
            ...
            System.out.println(bean.getContact_no());
            System.out.println(bean.getPlace_name());
            System.out.println(bean.getPlace_image()[0]);
            i++;
        }*/
       return list; 
   }
    
    public static List<CommonBean> getAllsaloonByAreaId_And_SubId_And_Type(int area_id,int sub_id,String type)
    {
      ResultSet rs=null; 
     
       String query="SELECT Places.Place_Id,Places_name,Address,Contact_no,Website_name,Description,Image_name FROM places INNER JOIN saloon ON saloon.Place_Id=places.Place_Id INNER JOIN place_image ON place_image.Place_Id=places.Place_Id" +
        ...
        try {
            ...
            Logger.getLogger(SaloonManager.class.getName()).log(Level.SEVERE, null, ex);
        }
   return list;
   }
