...
public class DoctorManager {
    ...
    public static List<CommonBean> getAllDoctorsByAreaId_And_SubId(int area_id,int sub_id)
    {
        ResultSet rs=null;
       
       String query="SELECT Places.Place_Id,Places_name,Address,Contact_no,Website_name,Description,Image_name,TYPE FROM places INNER JOIN doctor ON doctor.Place_Id=places.Place_Id INNER JOIN place_image ON place_image.Place_Id=places.Place_Id\n" +
   ...
   return list;
     ...
     public static List<CommonBean> getAlldoctorsByAreaId_And_SubId_And_Type(int area_id,int sub_id,String type)
    {
      ResultSet rs=null; 
     
       String query="SELECT Places.Place_Id,Places_name,Address,Contact_no,Website_name,Description,Image_name FROM places INNER JOIN doctor ON doctor.Place_Id=places.Place_Id INNER JOIN place_image ON place_image.Place_Id=places.Place_Id" +
