...
<head>
    <meta charset="UTF-8">
    <title>Add Category Page | Ahmedabad City Guide-admin</title>
                ...
                <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-xs-center">
                           ...
                           <span class="text-white"> Add Category<br/>
                                </span>
                        </h3>
                    </div>
                        ...
                        <form>
                           <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control  form-control-md" id="Category" name="Category" placeholder="Category" onblur="validate()" required="true">
                                </div>
                            </div>
                            <!--</h3>-->
                            <span id="first-span" style="color: #ececec;display : none "> *Enter proper Category Name</span>
                            <span id="secound-span2" style="color: #ececec;display : none "> *Enter only 15 characters</span>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <input type="button"name="add_category" onclick="addcategory()" value="Add" class="btn btn-primary btn-block login_button">
                                    </div>
                                </div>
                            </div>
