...
<head>
    <meta charset="UTF-8">
    <title>Add Super Market | Ahmedabad City Guide-admin</title>
                                        ...
                                        <form class="form-horizontal" method="post" action="../PlaceServlet" enctype="multipart/form-data">
                                            <fieldset>
                                                ...
                                                <input type="hidden" id="image_no" name="image_no" value="0">
                                                 <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2 text-lg-right">
                                                        <label for="name4" class=" form-control-label">Enter Super Market Name: <span style="color:red;">*</span></label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="Super Market Name" onblur="validatePlaceName()" required="true">
                                                            <span id="sname"></span>
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Enter Super Market Address: <span style="color:red;">*</span></label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="add" name="add" class="form-control" placeholder="Super Market Address" onblur="validateAddress()" required="true">
                                                            <span id="sadd"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Enter Super Market Website</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="website" name="website" class="form-control" placeholder="Super Market Website" onblur="validateWebsite()" required="true">
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Select Super Market image</label>
                                                    </div>
