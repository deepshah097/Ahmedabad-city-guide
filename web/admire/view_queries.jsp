<%@page import="AdminBean.ContactBean"%>
<%@page import="AdminManager.ContactManager"%>
...
<head
    <meta charset="UTF-8">
    <title>View Queries | Ahmedabad City Guide</title>
                            ...
                            <ol class="breadcrumb float-xs-right  nav_breadcrumb_top_align">
                                <li class="breadcrumb-item">
                                    <a href="index_admin.jsp">
                                        <i class="fa fa-home" data-pack="default" data-tags=""></i> Queries
                                    </a>
                                </li>
                               
                                <li class="active breadcrumb-item">View Queries</li>
                            </ol>
                        </div>
                    </div>
                    <div>
                                        ...
                                        <table id="table_user" class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Query</th>
                                                    
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <% 
                                                    List <ContactBean> list=ContactManager.viewQueries();
