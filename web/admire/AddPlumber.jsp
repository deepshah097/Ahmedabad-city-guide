...
<head>
    <meta charset="UTF-8">
    <title>Add Plumber | Ahmedabad City Guide-admin</title>
            ...
            <div class="col-xl-12">
                                <div class="card m-t-35">
                                    ...
                                    <div class="card-block">
                                        <form class="form-horizontal" method="post" action="../PlaceServlet1" enctype="multipart/form-data">
                                            <fieldset>
                                                <br>
                                         ...
                                         <input type="hidden" id="image_no" name="image_no" value="0">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2 text-lg-right">
                                                        <label for="name4" class=" form-control-label">Enter Plumber Name</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="Plumber Name">
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Enter Plumber Address</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="add" name="add" class="form-control" placeholder="Plumber Address">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Enter Plumber Website</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="website" name="website" class="form-control" placeholder="Plumber Website">
