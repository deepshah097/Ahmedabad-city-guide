...
<!-- Mirrored from dev.lorvent.com/admire/blank.html  HTTrack Website Copier/3.x [XR&CO'2010], Sat, 31 Dec 2016 07:06:04 GMT -->
<head>
    <meta charset="UTF-8">
    <title>Add School | Ahmedabad City Guide-admin</title>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2 text-lg-right">
                                                        <label for="name4" class=" form-control-label">Enter School Name:<span style="color:red;">*</span></label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="School Name" onblur="validatePlaceName()" required="true">
                                                            <span id="sname"></span>
                                                        </div>
                                                    </div>
                                                </div> 
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="add" name="add" class="form-control" placeholder="School Address" onblur="validateAddress()" required="true">
                                                            <span id="sname"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="website" name="website" class="form-control" placeholder="School Website" onblur="validateWebsite()" required="true">
                                               ...
                                               <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4">
                                                        &nbsp;
                                                        <input type="radio" id="hostel" name="hostel" value="1" onchange="hostel1(this.value)">&nbsp;&nbsp;Yes</input>
                                                        <input type="radio" id="hostel" name="hostel" value="0" onchange="hostel1(this.value)">&nbsp;&nbsp;No</input>
                                                        </div>
                                                </div>
                                                <div id="hosteldiv">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="hos_name" name="hos_name" class="form-control" placeholder="Hostel Name">
                                                        </div>
                                                    </div>
                                                </div>
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="hos_add" name="hos_add" class="form-control" placeholder="Hostel Address">
