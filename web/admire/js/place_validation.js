...
{
    var n=document.getElementById("description");
    var nspan=document.getElementById("sdes");
    var add=/^[A-Za-z0-9][A-Za-z0-9\s\-\,\.\ ]+/;
    var add1=/^[0-9]+$/;
    if(n.value.match(add1))
    {
       n.style="border:2px red solid";
       nspan.innerHTML="Description cannot contain only digits";
       nspan.style="display:block;color:red;";
       n.value="";
       n.focus(); 
    }
