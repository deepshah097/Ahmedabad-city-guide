...
<head>
    <meta charset="UTF-8">
    <title>Add Services | Ahmedabad City Guide-admin</title>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2 text-lg-right">
                                                        <label for="name4" class=" form-control-label">Enter Services Name</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            
                                                            <input type="text" id="hname" name="hname" class="form-control" placeholder="Services Name">
                                                        </div>
                                                    </div>
                                                </div> 
                                                 ...
                                                 <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Enter Services Address</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="hadd" name="hadd" class="form-control" placeholder="Services Address">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Enter Services Website</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="hwebsite" name="hwebsite" class="form-control" placeholder="Services Website">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2 text-lg-right">
                                                        <label for="gender4" class="form-control-label">Enter mini visiting fees</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4">
