...
<head>
  ...
  <title>View Profile | Ahmedabad City Guide</title>
...
<!--<div class="add_place none" id="autorized">-->
    <div class="place_form" style="width:617px;height:664px;">
        
      <h3>View Profile<span></span></h3>
      <% UserBean user=EditProfile.getuserbyemail1((String) session.getAttribute("user"));  %>

      <form action="EditProfile.jsp" method="post">
         
          
          <label>Name: <input type="text" disabled="true" name="fn" value="<%=user.getFname()+ " "+user.getLname()%>"></label>
       
        <label>Email Id:   <input type="text" disabled="true" name="fn" value=<%= user.getEmail_Id()%>></label>
        <label>Password:   <input type="text" disabled="true" name="fn" value=<%= user.getPassword()%>> </label>
        <label>Contact Number:<input type="text" disabled="true" name="fn" value=<%= user.getContact_No()%>></label>
         <label>Gender:<input type="text" disabled="true" name="contact" value=<%= user.getGender()%>></label>
       
        <!--<input type="submit" value="Edit">-->
         <a href="EditProfile.jsp" class="btn btn-success" style="width: 26%;
    margin-left: 35%;
    height: 60px;">Edit</a><br><br>
       
    <u><a href="Change_password.jsp" style="width: 26%;
    margin-left: 35%;
    height: 60px;">Change Password</a></u>
      </form>
    </div>
    <div style="margin-top: 446px;">
