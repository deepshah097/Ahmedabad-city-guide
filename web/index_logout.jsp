<%-- 
    Document   : index
    Created on : 9 Jan, 2017, 5:25:51 PM
    Author     : Nupur
--%>
...
<!-- Mirrored from www.ansonika.com/travelguide/index.html by HTTrack Website Copier/3.x [XR&CO'2010], Sat, 12 Nov 2016 09:08:38 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4" id="newsletter">
                    ...
                    <form method="post" action="http://www.ansonika.com/travelguide/assets/newsletter.php" name="newsletter_2" id="newsletter_2">
