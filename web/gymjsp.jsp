    ...
    <script>
         function getFilterValue(t,s)
        {
           // var t=document.getElementById("3 star").value;
            //alert(t);
            window.location="gym1.jsp?type="+t+"&sub_id="+s;
        ...
        <div class="row row-height">
            <div class="col-lg-7 col-md-6 content-left">
               <div id="filters_map">
                    ...
                    <div id="collapseFiltesmap" class="collapse">
                        ...
                        <div class="filter_type clearfix">
                            ...
                            <ul>
                                ...
                                <li>
                                    <label>Women</label>
                                    <input type="checkbox" class="js-switch" id="women" name="women" value="men" onchange="getFilterValue(this.value),'<%=subid%>'">
                                </li>
                                                            </ul>
                        </div>
                        <div class="filter_type clearfix">
                ...
                <div class="row">
                    <% 
                        List<CommonBean> cb=GymManager.getAllGymByAreaId_And_SubId(Integer.parseInt((String)session.getAttribute("area_id")), Integer.parseInt(request.getParameter("sub_id")));
                        int i = 0 ;
