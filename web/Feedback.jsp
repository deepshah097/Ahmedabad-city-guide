    ...
    <div class="container margin_60_30" >
        <div class="row">
            ...
            <div class="col-md-12">
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" id="message_contact" name="feedback"  class="form-control styled" style="height:100px;" placeholder="Your message" ></textarea>
                                    </div><div class="row">
                                <div class="col-md-6">
				...
				{%>
                                <span style="color:red"><%=request.getParameter("fd") %></span>
				<%} %>
                                </div>
