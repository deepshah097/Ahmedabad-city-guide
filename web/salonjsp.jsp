...
<head>
    ...
    <title>Saloon | Ahmedabad City Guide</title>
     ...
     function getFilterValue(t,s)
        {
           // var t=document.getElementById("3 star").value;
            //alert(t);
            window.location="salon1.jsp?type="+t+"&sub_id="+s;
        ...
        <div class="row row-height">
            <div class="col-lg-7 col-md-6 content-left">
               <div id="filters_map">
                    ...
                    <div id="collapseFiltesmap" class="collapse">
                        ...
                        <div class="filter_type clearfix">
                            ...
                            <ul>
                                <li>
                                    <label>Men</label>
                                    <input type="checkbox" class="js-switch" id="men" name="men" value="men" onchange="getFilterValue(this.value,'<%=subid%>')">
                                </li>
                                <li>
                                    <label>Women</label>
                                    <input type="checkbox" class="js-switch" id="Women" name="Women" value="Women" onchange="getFilterValue(this.value,'<%=subid%>')">
                                </li>
                                                            </ul>
                        </div>
                ...
                <div class="row">
                    <% 
                        List<CommonBean> cb=SaloonManager.getAllSaloonByAreaId_And_SubId(Integer.parseInt((String)session.getAttribute("area_id")), Integer.parseInt(request.getParameter("sub_id")));
                        int i = 0 ;
