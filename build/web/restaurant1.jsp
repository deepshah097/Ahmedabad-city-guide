...
<head>
    ...
    <script type="text/javascript">
        function getFilterValue()
        {
            ...
            alert(t);
            window.location="restaurant1.jsp?type=4";
            ...
            <div id="filters_map">
                    ...
                    <div id="collapseFiltesmap" class="collapse">
                        ...
                        <div class="filter_type clearfix">
                            ...
                            <ul>
                                <li>
                                    <label>3 star</label>
                                    <input type="checkbox" id="3 star" value="3" class="js-switch" onchange="getFilterValue()">
                                </li>
                                <li>
                                    <label>4 star</label>
                ...
                <div class="row">
                   ...
                   <%   List<CommonBean> cb=null;
                            ...
                            System.out.println("Type is ---------" +Integer.parseInt(request.getParameter("type")));
                           ...
                           cb=RestaurantManager.getAllRestaurantByAreaId_And_SubId_And_Type(area_id,sub_id,t);
                                               int i = 0 ;
                          System.out.println("------"+cb.get(0).getPlace_name());                     
                           for(CommonBean bean: cb)
                            {
                            String s="h" + i;
                           System.out.println("------" +bean.getAddress());
                           System.out.println("------------" +bean.getWebsite_name());
