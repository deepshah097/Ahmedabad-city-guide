...
<head>
    <meta charset="UTF-8">
    <title>Add Salon | Ahmedabad City Guide-admin</title>
                                           ...
                                           <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="Salon Name"onblur="validatePlaceName()" required="true">
                                                             <span id="sname"></span>
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="add" name="add" class="form-control" placeholder="Salon Address" onblur="validateAddress()" required="true">
                                                            <span id="sadd"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Enter Salon Website</label>
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="website" name="website" class="form-control" placeholder="Salon Website" onblur="validateWebsite()">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2  text-lg-right">
                                                        <label for="name5" class="form-control-label two_column_label_margintop">Select salon image</label>
                                                    </div>
