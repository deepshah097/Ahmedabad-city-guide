        ...
        function deleteCategory(cid)
        {
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    if(data)
                    {
                        alert("category with id "+cid+" deleted");
                        $.ajax({
                    ...
                    {
                        alert("category with id "+cid+" not deleted");
                                                ...
                                                <tr role="row" class="even">
                                                 ...
                                                 <i class="fa fa-eye text-success"></i></a>&nbsp; &nbsp;-->
                                                       <!-- <a class="edit" data-toggle="tooltip" data-placement="top" title="Edit" href="edit_user.html">
                                                        ...
                                                        <a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top" title="Delete" onclick="deleteCategory(<%=bean.getCategoryId()%>)">
