            ...
            <div class="col-xl-12">
                                <div class="card m-t-35">
                                    ...
                                    <div class="card-block">
                                        <form class="form-horizontal" method="post" action="../AddCookieServlet" enctype="multipart/form-data">
                                            <fieldset>
                                                <br>
                                                <input type="hidden" id="subcat" name="subcat" value="12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="Cafe Name" onblur="validatePlaceName()" required="true">
                                                            <span id="sname"></span>
                                                        </div>
                                                    </div>
                                                </div> 
                                             <span id="sname" style="display:none;"></span>
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="add" name="add" class="form-control" placeholder="Cafe Address" onblur="validateAddress()" required="true">
                                                            <span id="sadd"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="website" name="website" class="form-control" placeholder="Cafe Website" onblur="validateWebsite()">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3 col-xl-2 text-lg-right">
                                                        <label for="name4" class=" form-control-label">Enter Description:<span style="color:red;">*</span>(Include details of menu items offered and opening and closing hours)</label>
                                                        
                                                    </div>
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            <textarea id="description" name="description" rows="3" class="form-control" required="true"></textarea>
