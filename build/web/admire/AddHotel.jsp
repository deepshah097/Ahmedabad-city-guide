...
<head>
    <meta charset="UTF-8">
    <title>Add Hotel | Ahmedabad City Guide-admin</title>
                                           ...
                                           <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="name" name="name" class="form-control" placeholder="Hotel Name"onblur="validatePlaceName()" required="true">
                                                             <span id="sname"></span>
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="add" name="add" class="form-control" placeholder="Hotel Address" onblur="validateAddress()" required="true">
                                                            <span id="sadd"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8 col-xl-4  two_column_signup_margintop">
                                                        <div class="input-group">
                                                            <input type="text" id="website" name="website" class="form-control" placeholder="Hotel Website" onblur="validateWebsite()">
