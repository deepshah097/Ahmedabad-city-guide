<%@page import="Manager.Service_Center"%>
...
<head>
    ...
    <title>Service Center | Ahmedabad City Guide</title>
        ...
        <div class="row row-height">
            <div class="col-lg-7 col-md-6 content-left">
               <div id="filters_map">
                ...
                <div class="row">
                    <% 
                        List<CommonBean> cb=Service_Center.getAllService_CentersByAreaId_And_SubId(Integer.parseInt((String)session.getAttribute("area_id")), Integer.parseInt(request.getParameter("sub_id")));
                        int i = 0 ;
