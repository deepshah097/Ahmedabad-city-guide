...
<%@page import="Manager.RestaurantManager"%>
<!DOCTYPE html>
...
<head>
    ...
    <title>Restaurant | Ahmedabad City Guide</title>
     ...
     <script type="text/javascript">
        function getFilterValue(t,s)
        {
           // var t=document.getElementById("3 star").value;
            //alert(t);
            window.location="restaurant1.jsp?type="+t+"&sub_id="+s;
        ...
        <div class="row row-height">
            <div class="col-lg-7 col-md-6 content-left">
                    ...
                    <div id="collapseFiltesmap" class="collapse">
                        <div class="filter_type clearfix">
                            ...
                            <ul>
                                <li>
                                    <label>3 star</label>
                                    <input type="checkbox" id="3 star" value="3" class="js-switch" onchange="getFilterValue(this.value,'<%=subid%>')">
                                </li>
                                <li>
                                    <label>4 star</label>
                                    <input type="checkbox" id="4 star" value="4" class="js-switch" onchange="getFilterValue(this.value,'<%=subid%>')">
                                </li>
                                <li>
                                    <label>5 star</label>
                                    <input type="checkbox" id="5 star" value="5" class="js-switch" onchange="getFilterValue(this.value,'<%=subid%>')">
                                </li>
                ...
                <div class="row">
                      ...
                      <% 
                        List<CommonBean> cb=RestaurantManager.getAllRestaurantByAreaId_And_SubId(Integer.parseInt((String)session.getAttribute("area_id")), Integer.parseInt(request.getParameter("sub_id")));
