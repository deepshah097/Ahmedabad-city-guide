...
<%@page import="Manager.DoctorManager"%>
...
<head>
    ...
    <title>Doctor | Ahmedabad City Guide</title>
    ...
    function getFilterValue(t,s)
        {
           // var t=document.getElementById("3 star").value;
            //alert(t);
            window.location="doctor1.jsp?type="+t+"&sub_id="+s;
        ...
        <div class="row row-height">
            <div class="col-lg-7 col-md-6 content-left">
                        ...
                        <div class="filter_type clearfix">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <input type="checkbox" class="js-switch" id="Physiotherapist" value="Physiotherapist" name="Physiotherapist" onchange="getFilterValue(this.value,'<%=subid%>')">
                                </li>
                                <li>
                                    <label>Dentist</label>
                                    <input type="checkbox" class="js-switch" id="Dentist" name="Dentist" value="Dentist" onchange="getFilterValue(this.value,'<%=subid%>')">
                                </li>
                                <li>
                                    <label>Physician</label>
                                    <input type="checkbox" class="js-switch" id="Physician" name="Physician" value="Physician" onchange="getFilterValue(this.value,'<%=subid%>')">
                                </li>
                                <li>
                ...
                <div class="row">
                    ...
                    <% 
                        List<CommonBean> cb=DoctorManager.getAllDoctorsByAreaId_And_SubId(Integer.parseInt((String)session.getAttribute("area_id")), Integer.parseInt(request.getParameter("sub_id")));
