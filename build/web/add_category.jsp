<%-- 
    ...
    Created on : 21 Jan, 2017, 2:49:21 PM
    Author     : Nupur
--%>
                ...
                <div class="row">
                    <form>
                        <label style="align:center;">
                            Category:
                            <input type="text" name="categoryname" style="width: 200px;height: 30px;">
                        </label>
                        <br>
                        <input type="submit" name="add_category" value="Add" style="margin-left: 100px;" >
